...
<head>
  <meta charset="UTF-8">
  <title>Welcome to Fraties!</title>
...
<body>
       <div>
            <form method="post">
                <h1>Hey this is acemvito@gmail.com!</h1>
                ...
                <p>Or <button name="resend" id="resend" type="submit" class="btn">click here</button> to resend the verification email.</p><br><br><br><br>
                <p><?php
                    if(isset($_POST['resend'])){
                            $email = "usask@mail.usask.ca";
                            $to      = "vitogeek@gmail.com"; // Send email to our user
                        ...
                        http://localhost/Fraties/Login/verify.php?Email=nsid&Password=pass&NSID=nsid
                                            '; // Our message above including the link

                                $headers = 'From:noreply@fraties.com' . "\r\n"; // Set from headers
                              echo mail($to, $subject, $message, $headers); // Send our email 
                         
                        echo "This is echo after mail";
                    }
                ?></p>
                <br>
                <?php 
